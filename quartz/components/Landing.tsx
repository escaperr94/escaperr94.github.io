      ...
      <div class="card card-1">
        <div class="card-content">
          ...
          <div class="card-illustration-area">
            <img src="/static/card-img-1.png" class="card-illustration-1" />
            <img src="/static/card-img-1-color.png" class="card-illustration-1-color" />
          </div>
        </div>
    ...
    <a href={"/science-theory"}>
      <div class="card card-2">
        <div class="card-content">
          ...
          <div class="card-illustration-area">
            <img src="/static/card-img-2.png" class="card-illustration-2" />
            <img src="/static/card-img-2-color.png" class="card-illustration-2-color" />
          </div>
        </div>
    ...
    <a href={"/books-sources"}>
      <div class="card card-3">
        <div class="card-content">
          ...
          <div class="card-illustration-area">
            <img src="/static/card-img-3.png" class="card-illustration-3" />
            <img src="/static/card-img-3-color.png" class="card-illustration-3-color" />
          </div>
        </div>
    ...
    <a href={"/personal-essays"}>
      <div class="card card-4">
        <div class="card-content">
          ...
          <div class="card-illustration-area">
            <img src="/static/card-img-4.png" class="card-illustration-4" />
            <img src="/static/card-img-4-color.png" class="card-illustration-4-color" />
          </div>
        </div>
    ...
    <a href={"/side-quests"}>
      <div class="card card-5">
        <div class="card-content">
          ...
          <div class="card-illustration-area">
            <img src="/static/card-img-5.png" class="card-illustration-5" />
            <img src="/static/card-img-5-color.png" class="card-illustration-5-color" />
          </div>
        </div>
      ...
      <div class="landing-page">
        ...
        <div class="content-container">
          ...
          <div class="character-container">
            <img src="/static/osamu_landing.png" alt="Osamu Character" class="anime-character" />
          </div>
