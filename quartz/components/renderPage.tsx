  ...
  const doc = (
    <html lang={pageLang}>
      ...
      <body data-slug={slug}>
        <div class="marquee">
          <p>
          anime enjoyer • builder • learner • system tinkerer • AI + math explorer • code writer • 
midnight debugger • bug fixer • problem breaker • low-level curious • pattern spotter • 
research-minded • quiet observer • open to change • always prototyping • 
sometimes overthinking • often simplifying • notes collector • visual thinker • 
likes beautiful ideas • still figuring things out • anime enjoyer • builder • learner • system tinkerer • AI + math explorer • code writer • 
midnight debugger • bug fixer • problem breaker • low-level curious • pattern spotter • 
research-minded • quiet observer • open to change • always prototyping • 
sometimes overthinking • often simplifying • notes collector • visual thinker • 
likes beautiful ideas • still figuring things out
          </p>
        </div>
